...
- `programs.zed-editor.userSettings.buffer_line_height = "comfortable"` を設定する。
...
- `programs.zed-editor.userSettings.show_wrap_guides = false` を設定する。
- `inlay_hints` は設定しない。
...
- `programs.zed-editor.userSettings.agent.enabled = false` を設定する。
- `programs.zed-editor.userSettings.agent.button = false` を設定する。
- `programs.zed-editor.userSettings.agent.dock = "right"` を設定する。
...
- `programs.zed-editor.userSettings.terminal.button = true` を設定する。
- terminalのenvには秘密情報やmachine localな値を設定しない。

### Panels and Git

- `programs.zed-editor.userSettings.project_panel.button = true` を設定する。
- `programs.zed-editor.userSettings.project_panel.dock = "left"` を設定する。
- `programs.zed-editor.userSettings.project_panel.git_status = true` を設定する。
- `programs.zed-editor.userSettings.outline_panel.button = true` を設定する。
- `programs.zed-editor.userSettings.outline_panel.dock = "left"` を設定する。
- `programs.zed-editor.userSettings.git_panel.button = true` を設定する。
- `programs.zed-editor.userSettings.git_panel.dock = "left"` を設定する。
- `programs.zed-editor.userSettings.git_panel.status_style = "icon"` を設定する。
- `programs.zed-editor.userSettings.collaboration_panel.button = false` を設定する。
- `programs.zed-editor.userSettings.collaboration_panel.dock = "left"` を設定する。
- `programs.zed-editor.userSettings.diagnostics.button = false` を設定する。
- `programs.zed-editor.userSettings.debugger.button = false` を設定する。
- panel dockはZedのClassic layoutに合わせる。
- panel width、sort、open状態はZed既定に任せる。
...
- 評価結果で `programs.zed-editor.userSettings.buffer_line_height = "comfortable"` になっていること。
...
- 評価結果で `programs.zed-editor.userSettings.show_wrap_guides = false` になっていること。
